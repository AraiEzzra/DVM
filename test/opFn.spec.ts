...
import { OpFnSync } from 'src/OpInst';
import { opAdd, opSub, opMul, opDiv, opSdiv, opMod, opSmod, opExp, opSignExtend, opLt, opGt, opSlt, opSgt, opEq, opAnd, opOr, opXor, opByte, opSHL, opSHR, opSAR } from 'src/opFn';
import { State } from 'src/State';

const isBigIntEqual = (a: bigint, b: bigint) => expect(a === b, `${a.toString(16)} !== ${b.toString(16)}`).to.true;

const twoOpMethods = new Map<string, OpFnSync>([
	['add', opAdd],
	['sub', opSub],
	['mul', opMul],
	['div', opDiv],
...
const testOpFn = (stack: Array<string>, opFn: OpFnSync, expected: string) => {
